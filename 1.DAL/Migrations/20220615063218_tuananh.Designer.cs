...
namespace _1.DAL.Migrations
{
    ...
    [Migration("20220615063218_tuananh")]
    partial class tuananh
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_1.DAL.ModelContext.HangHoa", b =>
                {
            ...
            modelBuilder.Entity("_1.DAL.ModelContext.KhachHang", b =>
                {
            ...
            modelBuilder.Entity("_1.DAL.ModelContext.NhanVien", b =>
                {
                    b.Property<string>("MaNV")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("_1.DAL.ModelContext.HangHoa", b =>
                {
                    b.HasOne("_1.DAL.ModelContext.NhanVien", "MaNVNavigation")
                        .WithMany("SanPhams")
                        .HasForeignKey("MaNV")
